...
import { Colors } from "../../styles/Colors";
  ...
  const SelectPetVaccines = () => {
    ...
    const goToIdInfoPet = (id) => {
      
      navigation.navigate("PetVaccinesRecord", {id: id})
    }
    ...
    const renderPets = (item) => {
      ...
      return (
        <TouchableOpacity style={styles.item} onPress={() => goToIdInfoPet(item.id)}>
          ...
          <Image
               source={require("../../assets/vet-option1.png")}
  ...
  export default SelectPetVaccines;
